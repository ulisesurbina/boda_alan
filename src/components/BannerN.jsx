      ...
      <div className='HeroBanner'>
        ...
        <div className='ContenidoBanner'>
          ...
          <div className='ContenidoBanner_texto' data-aos="zoom-in">
            <h5>¡Bienvenidos a nuestra historia de amor! <span className="Heart"><svg width="100%" height="auto" viewBox="0 0 1387 1233" fill="none" xmlns="http://www.w3.org/2000/svg">
